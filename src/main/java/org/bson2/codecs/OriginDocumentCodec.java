 ...
 * @since 3.0
 */
public class OriginDocumentCodec implements CollectibleCodec<Document> {
     ...
     */
    public OriginDocumentCodec(final CodecRegistry registry, final BsonTypeClassMap bsonTypeClassMap) {
     ...
     */
    public OriginDocumentCodec(final CodecRegistry registry, final BsonTypeClassMap bsonTypeClassMap, final Transformer valueTransformer) {
