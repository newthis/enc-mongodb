...
public interface BSONCallback {
     ...
     * @see org.bson2.BsonType#NULL
     */
    void gotNull(String name);

    /**
     * Called when reading a field with a {@link org.bson2.BsonType#UNDEFINED} value.
     *
     * @param name the name of the field
     * @see org.bson2.BsonType#UNDEFINED
     */
    void gotUndefined(String name);

    /**
     * Called when reading a field with a {@link org.bson2.BsonType#MIN_KEY} value.
     *
     * @param name the name of the field
     */
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#MAX_KEY} value.
     *
     * @param name the name of the field
     */
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#BOOLEAN} value.
     *
     * @param name  the name of the field
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#DOUBLE} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#DECIMAL128} value.
     *
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#INT32} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#INT64} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#DATE_TIME} value.
     *
     * @param name   the name of the field
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#STRING} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#SYMBOL} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#REGULAR_EXPRESSION} value.
     *
     * @param name    the name of the field
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#TIMESTAMP} value.
     *
     * @param name      the name of the field
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#OBJECT_ID} value.
     *
     * @param name the name of the field
    ...
    /**
     * Invoked when {@link org.bson2.BSONDecoder} encountered a {@link org.bson2.BsonType#DB_POINTER} type field in a byte sequence.
     *
     * @param name      the name of the field
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#BINARY} value. Note that binary values have a subtype, which may
     * determine how the value is processed.
     *
     * @param name the name of the field
     * @param type one of the binary subtypes: {@link org.bson2.BsonBinarySubType}
     * @param data the field's value
     */
     ...
     * {@link org.bson2.BsonBinarySubType#UUID_LEGACY}
     *
     * @param name  the name of the field
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#JAVASCRIPT} value.
     *
     * @param name the name of the field
    ...
    /**
     * Called when reading a field with a {@link org.bson2.BsonType#JAVASCRIPT_WITH_SCOPE} value.
     *
     * @param name  the name of the field
     * @param code  the JavaScript code
