...
import static com.mongodb2.DBObjects.toDBObject;
...
public class DBCursor implements Cursor, Iterable<DBObject> {
     ...
     * @return {@code this} so calls can be chained
     *
     * @see com.mongodb2.DBCursor#sort(DBObject)
     * @see com.mongodb2.DBCursor#hint(DBObject)
     ...
     * @deprecated Replaced with {@link com.mongodb2.ReadPreference#secondaryPreferred()}
     */
    @Deprecated
