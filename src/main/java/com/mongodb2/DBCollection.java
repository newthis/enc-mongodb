...
import com.mongodb2.client.model.DBCollectionCountOptions;
import com.mongodb2.client.model.DBCollectionDistinctOptions;
import com.mongodb2.client.model.DBCollectionFindAndModifyOptions;
import com.mongodb2.client.model.DBCollectionFindOptions;
import com.mongodb2.client.model.DBCollectionRemoveOptions;
import com.mongodb2.client.model.DBCollectionUpdateOptions;
...
import com.mongodb2.operation.BaseWriteOperation;
...
import com.mongodb2.operation.DeleteOperation;
...
import com.mongodb2.operation.InsertOperation;
import com.mongodb2.operation.ListIndexesOperation;
import com.mongodb2.operation.MapReduceBatchCursor;
import com.mongodb2.operation.MapReduceStatistics;
import com.mongodb2.operation.MapReduceToCollectionOperation;
import com.mongodb2.operation.MapReduceWithInlineResultsOperation;
import com.mongodb2.operation.MixedBulkWriteOperation;
import com.mongodb2.operation.OperationExecutor;
import com.mongodb2.operation.ParallelCollectionScanOperation;
import com.mongodb2.operation.RenameCollectionOperation;
import com.mongodb2.operation.UpdateOperation;
import com.mongodb2.operation.WriteOperation;
...
import org.bson2.codecs.BsonValueCodec;
...
import static com.mongodb2.AggregationOptions.OutputMode.CURSOR;
import static com.mongodb2.AggregationOptions.OutputMode.INLINE;
import static com.mongodb2.BulkWriteHelper.translateBulkWriteResult;
import static com.mongodb2.BulkWriteHelper.translateWriteRequestsToNew;
import static com.mongodb2.MongoNamespace.checkCollectionNameValidity;
import static com.mongodb2.ReadPreference.primary;
import static com.mongodb2.ReadPreference.primaryPreferred;
...
public class DBCollection {
     ...
     * @throws com.mongodb2.DuplicateKeyException if the write failed to a duplicate unique key
     * @throws com.mongodb2.WriteConcernException if the write failed due some other failure specific to the insert command
     ...
     * @return the result of the operation
     * @throws com.mongodb2.DuplicateKeyException if the write failed to a duplicate unique key
     * @throws com.mongodb2.WriteConcernException if the write failed due some other failure specific to the insert or update command
     * @throws MongoException if the operation failed for some other reason
    ...
    private WriteResult replaceOrInsert(final DBObject obj, final Object id, final WriteConcern writeConcern) {
        ...
        UpdateRequest replaceRequest = new UpdateRequest(wrap(filter), wrap(obj, objectCodec),
                                                         com.mongodb2.bulk.WriteRequest.Type.REPLACE).upsert(true);
     ...
     * @return the result of the operation
     * @throws com.mongodb2.DuplicateKeyException if the write failed to a duplicate unique key
     * @throws com.mongodb2.WriteConcernException if the write failed due some other failure specific to the update command
     * @throws MongoException if the operation failed for some other reason
    ...
    public WriteResult update(final DBObject query, final DBObject update, final DBCollectionUpdateOptions options) {
        ...
        if (!update.keySet().isEmpty() && update.keySet().iterator().next().startsWith("$")) {
            UpdateRequest updateRequest = new UpdateRequest(wrap(query), wrap(update, options.getEncoder()),
                    com.mongodb2.bulk.WriteRequest.Type.UPDATE).upsert(options.isUpsert()).multi(options.isMulti())
            ...
            UpdateRequest replaceRequest = new UpdateRequest(wrap(query), wrap(update, options.getEncoder()),
                    com.mongodb2.bulk.WriteRequest.Type.REPLACE).upsert(options.isUpsert()).multi(options.isMulti())
                    .collation(options.getCollation());
     ...
     *              in the collection.
     * @return the result of the operation
     * @throws com.mongodb2.WriteConcernException if the write failed due some other failure specific to the delete command
     * @throws MongoException if the operation failed for some other reason
     ...
     * @deprecated use {@link com.mongodb2.DBCursor#skip(int)}, {@link com.mongodb2.DBCursor#batchSize(int)} and {@link
     * com.mongodb2.DBCursor#setOptions(int)} on the {@code DBCursor} returned from {@link com.mongodb2.DBCollection#find(DBObject,
     * DBObject)}
     */
    @Deprecated
     ...
     * @return A cursor to the documents that match the query criteria
     * @mongodb.driver.manual tutorial/query-documents/ Querying
     * @deprecated use {@link com.mongodb2.DBCursor#skip(int)} and {@link com.mongodb2.DBCursor#batchSize(int)} on the {@code DBCursor}
     * returned from {@link com.mongodb2.DBCollection#find(DBObject, DBObject)}
     */
    @Deprecated
    public DBCursor find(final DBObject query, final DBObject projection, final int numToSkip, final int batchSize) {
     ...
     * @deprecated Use {@link com.mongodb2.DBCollection#aggregate(java.util.List)} instead
     */
    @Deprecated
    @SuppressWarnings("unchecked")
