...
import com.mongodb2.binding.ClusterBinding;
import com.mongodb2.binding.ConnectionSource;
import com.mongodb2.binding.ReadBinding;
import com.mongodb2.binding.ReadWriteBinding;
import com.mongodb2.binding.SingleServerBinding;
...
import com.mongodb2.connection.SocketStreamFactory;
...
import com.mongodb2.operation.CurrentOpOperation;
import com.mongodb2.operation.FsyncUnlockOperation;
import com.mongodb2.operation.ListDatabasesOperation;
import com.mongodb2.operation.OperationExecutor;
import com.mongodb2.operation.ReadOperation;
import com.mongodb2.operation.WriteOperation;
import com.mongodb2.selector.LatencyMinimizingServerSelector;
import com.mongodb2.selector.ServerSelector;
...
import static com.mongodb2.connection.ClusterType.REPLICA_SET;
...
public class Mongo {
     ...
     * @see com.mongodb2.ServerAddress
     ...
     *     {@link com.mongodb2.client.MongoDatabase} instances created via {@link MongoClient#getDatabase(String)}
     * </p>
     *
     ...
     * com.mongodb2.MongoClient#getMongoClientOptions()}
     */
    @Deprecated
     ...
     * @deprecated Replaced with {@link com.mongodb2.MongoClient#listDatabaseNames()}
     */
    @Deprecated
    ...
    /**
     * Gets a database object. Users should use {@link com.mongodb2.MongoClient#getDatabase(String)} instead.
     *
     * <p>
     * The {@link DB} class has been superseded by {@link com.mongodb2.client.MongoDatabase}.  The deprecation of this method effectively
     ...
     * @deprecated use {@link com.mongodb2.MongoClient#getDatabase(String)}
     */
    @Deprecated
