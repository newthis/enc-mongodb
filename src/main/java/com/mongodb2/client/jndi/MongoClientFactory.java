...
package com.mongodb2.client.jndi;

import com.mongodb2.MongoClient;
import com.mongodb2.MongoClientURI;
...
public class MongoClientFactory implements ObjectFactory {
     ...
     *
     * Note: Not all options that can be specified via {@link com.mongodb2.MongoClientOptions} can be specified via the connection string.
     */
    @Override
