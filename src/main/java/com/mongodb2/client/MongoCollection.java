 ...
 * {@link org.bson2.codecs.Codec} registered in the {@link CodecRegistry}. The default {@code CodecRegistry} includes built-in support for:
 * {@link org.bson2.BsonDocument}, {@link Document} and {@link com.mongodb2.DBObject}.
 * </p>
 *
...
public interface MongoCollection<TDocument> {
     ...
     *
     * @param codecRegistry the new {@link org.bson2.codecs.configuration.CodecRegistry} for the collection
     ...
     *
     * @param readPreference the new {@link com.mongodb2.ReadPreference} for the collection
     ...
     *
     * @param writeConcern the new {@link com.mongodb2.WriteConcern} for the collection
     ...
     * @throws com.mongodb2.MongoBulkWriteException if there's an exception in the bulk write operation
     * @throws com.mongodb2.MongoException          if there's an exception running the operation
     */
     ...
     * @throws com.mongodb2.MongoWriteException        if the write failed due some other failure specific to the insert command
     * @throws com.mongodb2.MongoWriteConcernException if the write failed due being unable to fulfil the write concern
     * @throws com.mongodb2.MongoException             if the write failed due some other failure
     */
     ...
     * @throws com.mongodb2.MongoWriteException        if the write failed due some other failure specific to the insert command
     * @throws com.mongodb2.MongoWriteConcernException if the write failed due being unable to fulfil the write concern
     * @throws com.mongodb2.MongoCommandException      if the write failed due to document validation reasons
     * @throws com.mongodb2.MongoException             if the write failed due some other failure
     * @since 3.2
     */
     ...
     * @throws com.mongodb2.MongoBulkWriteException if there's an exception in the bulk write operation
     * @throws com.mongodb2.MongoException          if the write failed due some other failure
     * @see com.mongodb2.client.MongoCollection#bulkWrite
     */
     ...
     * @throws com.mongodb2.WriteConcernException if the write failed due being unable to fulfil the write concern
     * @throws com.mongodb2.MongoException        if the write failed due some other failure
     */
     ...
     * @throws com.mongodb2.MongoWriteException        if the write failed due some other failure specific to the delete command
     * @throws com.mongodb2.MongoWriteConcernException if the write failed due being unable to fulfil the write concern
     * @throws com.mongodb2.MongoException             if the write failed due some other failure
     */
     ...
     * @throws com.mongodb2.MongoWriteException        if the write failed due some other failure specific to the replace command
     * @throws com.mongodb2.MongoWriteConcernException if the write failed due being unable to fulfil the write concern
     * @throws com.mongodb2.MongoException             if the write failed due some other failure
     ...
     * @throws com.mongodb2.MongoWriteException        if the write failed due some other failure specific to the update command
     * @throws com.mongodb2.MongoWriteConcernException if the write failed due being unable to fulfil the write concern
     * @throws com.mongodb2.MongoException             if the write failed due some other failure
     ...
     * @throws com.mongodb2.MongoServerException if you provide a newCollectionName that is the name of an existing collection, or if the
     ...
     * @throws com.mongodb2.MongoServerException if you provide a newCollectionName that is the name of an existing collection and dropTarget
