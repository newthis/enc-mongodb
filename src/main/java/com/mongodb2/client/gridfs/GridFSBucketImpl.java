...
final class GridFSBucketImpl implements GridFSBucket {
    ...
    public GridFSDownloadStream openDownloadStreamByName(final String filename) {
        return openDownloadStreamByName(filename, new com.mongodb2.client.gridfs.model.GridFSDownloadByNameOptions());
    }
    ...
    @SuppressWarnings("deprecation")
    public GridFSDownloadStream openDownloadStreamByName(final String filename,
                                                         final com.mongodb2.client.gridfs.model.GridFSDownloadByNameOptions options) {
    ...
    public void downloadToStreamByName(final String filename, final OutputStream destination) {
        downloadToStreamByName(filename, destination, new com.mongodb2.client.gridfs.model.GridFSDownloadByNameOptions());
    }
