...
package com.mongodb2.gridfs;

import com.mongodb2.BasicDBObject;
import com.mongodb2.DB;
import com.mongodb2.DBCollection;
import com.mongodb2.DBCursor;
...
public class GridFS {
     ...
     *
     * @deprecated You can calculate max chunkSize with a similar formula {@link com.mongodb2.MongoClient#getMaxBsonObjectSize()} - 500*1000.
     ...
     * @throws com.mongodb2.MongoException if there's a failure
     ...
     * @throws com.mongodb2.MongoException if the operation fails
     */
    ...
    /**
     * Creates a file entry. After calling this method, you have to call {@link com.mongodb2.gridfs.GridFSInputFile#save()}.
     *
