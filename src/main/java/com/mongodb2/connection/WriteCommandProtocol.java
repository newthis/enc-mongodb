...
import static com.mongodb2.connection.ProtocolHelper.getCommandFailureException;
...
import static com.mongodb2.connection.WriteCommandResultHelper.getBulkWriteException;
import static com.mongodb2.connection.WriteCommandResultHelper.getBulkWriteResult;
...
abstract class WriteCommandProtocol implements Protocol<BulkWriteResult> {
     ...
     * @return the logger
     */
    protected abstract com.mongodb2.diagnostics.logging.Logger getLogger();
