 ...
 * @see com.mongodb2.DBCollection#initializeUnorderedBulkOperation()
 *
...
public class BulkWriteOperation {
     ...
     * @throws com.mongodb2.BulkWriteException if the write failed due some other failure specific to the write command
