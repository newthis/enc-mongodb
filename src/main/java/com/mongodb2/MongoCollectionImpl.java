...
import com.mongodb2.client.AggregateIterable;
import com.mongodb2.client.DistinctIterable;
import com.mongodb2.client.FindIterable;
import com.mongodb2.client.ListIndexesIterable;
import com.mongodb2.client.MapReduceIterable;
...
class MongoCollectionImpl<TDocument> implements MongoCollection<TDocument> {
    ...
    private DeleteResult delete(final Bson filter, final DeleteOptions deleteOptions, final boolean multi) {
        com.mongodb2.bulk.BulkWriteResult result = executeSingleWriteRequest(new DeleteRequest(toBsonDocument(filter)).multi(multi)
